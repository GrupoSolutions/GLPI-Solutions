...
class PluginFieldsPeripheraltestedropdownInjection extends PluginFieldsPeripheraltestedropdown implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Peripheral::getTypeName() . " - testedropdown";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Peripheral', 2);
