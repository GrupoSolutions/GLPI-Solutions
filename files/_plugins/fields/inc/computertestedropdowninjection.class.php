...
class PluginFieldsComputertestedropdownInjection extends PluginFieldsComputertestedropdown implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Computer::getTypeName() . " - testedropdown";
   }
