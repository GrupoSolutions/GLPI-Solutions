...
class PluginFieldsPhonetempodeexpiraoInjection extends PluginFieldsPhonetempodeexpirao implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Phone::getTypeName() . " - Tempo de expiração";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Phone', 3);
