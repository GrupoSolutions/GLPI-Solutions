...
class PluginFieldsPrinterativooperacaoInjection extends PluginFieldsPrinterativooperacao implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Printer::getTypeName() . " - ativoOperacao";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Printer', 4);
