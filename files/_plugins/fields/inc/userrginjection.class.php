...
class PluginFieldsUserrgInjection extends PluginFieldsUserrg implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('User', 1);
