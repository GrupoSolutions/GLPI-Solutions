...
class PluginFieldsComputertempodeexpiraoInjection extends PluginFieldsComputertempodeexpirao implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Computer::getTypeName() . " - Tempo de expiração";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Computer', 3);
