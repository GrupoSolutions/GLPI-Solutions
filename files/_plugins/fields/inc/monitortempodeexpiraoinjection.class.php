...
class PluginFieldsMonitortempodeexpiraoInjection extends PluginFieldsMonitortempodeexpirao implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Monitor::getTypeName() . " - Tempo de expiração";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Monitor', 3);
