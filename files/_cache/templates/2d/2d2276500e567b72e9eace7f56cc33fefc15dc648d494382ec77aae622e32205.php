...
class __TwigTemplate_2c22b6a53b46a2469b263b8a9137761c90fde9b1fd8e69c0a3d98f346ac7cd4d extends Template
{
    private $source;
    private $macros = [];
...
<body class=\"{{ user_pref('fold_menu') and is_vertical ? 'navbar-collapsed' : '' }} {{ is_vertical ? 'vertical-layout' : 'horizontal-layout' }} {{ is_debug_active ? 'debug-active' : '' }}\">
   ...
   <div class=\"page\">
      ...
      <div class=\"page-wrapper mb-0\">
         <div class=\"page-body container-fluid\">
            <main role=\"main\" id=\"page\" class=\"legacy\">
", "layout/parts/page_header.html.twig", "C:\\wamp64\\www\\glpi104\\templates\\layout\\parts\\page_header.html.twig");
    }
}
