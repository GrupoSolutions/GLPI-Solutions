...
class __TwigTemplate_1f5eb984e53f9af46706d877285bc6f13c997b7f266b1445b619c0a6ce0b061a extends Template
{
    private $source;
    private $macros = [];
...
($context["language"] ?? null)]], 69, $context, $this->getSourceContext());
    ...
    ";
        // line 84
        echo twig_call_macro($macros["fields"], "macro_textareaField", ["content", (($__internal_compile_9 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 84)) && is_array($__internal_compile_9) || $__internal_compile_9 instanceof ArrayAccess ? ($__internal_compile_9["content"] ?? null) : null), __("Header", "formcreator"), ["enable_richtext" => true]], 84, $context, $this->getSourceContext());
        echo "
...
";
    ...
    {
        return new Source("", "@formcreator/pages/form.html.twig", "C:\\xampp\\htdocs\\glpi\\marketplace\\formcreator\\templates\\pages\\form.html.twig");
    }
}
