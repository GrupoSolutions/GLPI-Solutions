...
class __TwigTemplate_8396c4c25150a25c77196729cfde4871ad6a8abfe2277e31515159b0fe42a6b5 extends Template
{
    private $source;
    private $macros = [];
...
<form action=\"{{ path('front/search.php') }}\" role=\"search\" method=\"get\" data-submit-once>
   <div class=\"input-group input-group-flat\">
      ...
      <span class=\"input-group-text\">
         <button type=\"submit\" class=\"btn btn-link p-0 m-0 lupa\" title=\"{{ __('Search…') }}\">
            <span class=\"ti ti-search\" aria-hidden=\"true\"></span>
         </button>
      </span>
   </div>
...
{% endif %}
", "layout/parts/global_search_form.html.twig", "C:\\wamp64\\www\\glpi104\\templates\\layout\\parts\\global_search_form.html.twig");
    }
}
