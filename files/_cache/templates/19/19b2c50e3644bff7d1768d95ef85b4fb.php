...
class __TwigTemplate_9e775cf62ea901831daeebe1a7736d19 extends Template
{
    private $source;
    private $macros = [];
...
";
   ...
   ";
            // line 38
            if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isField", ["date_creation"], "method", false, false, false, 38)) {
                // line 39
   ...
   ";
            // line 44
            if (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "isField", ["date_mod"], "method", false, false, false, 44)) {
                // line 45
                echo "   <div class=\"col-sm-6 col-12\">
      ";
                // line 46
