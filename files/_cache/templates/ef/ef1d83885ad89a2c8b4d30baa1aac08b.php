...
class __TwigTemplate_7cec53d0ec69cbd69ccf11163962c2ce extends Template
{
    private $source;
    private $macros = [];
...
($context["is_expanded"] ?? null)) ? ("col-sm-6") : (""))]], 220, $context, $this->getSourceContext());
   ...
   ";
    ...
    {
        return new Source("", "components/itilobject/service_levels.html.twig", "C:\\wamp64\\www\\glpi108\\templates\\components\\itilobject\\service_levels.html.twig");
    }
}
