...
class __TwigTemplate_f6c6ac22e8246241bfe3a7c17c303148 extends Template
{
    private $source;
    private $macros = [];
...
{% if itemtype|itemtype_name != 'Chamado' %}
<form id=\"massform{{ normalized_itemtype }}\" method=\"get\" action=\"{{ path('front/massiveaction.php') }}\"
   ...
   <div class=\"card card-sm mt-0 search-card\">
      ...
      <pre>{{ itemtype|itemtype_name }}</pre>
...
{% if not is_ajax %}
   ...
   {% endif %}
{% endif %}
", "components/search/display_data.html.twig", "C:\\wamp64\\www\\glpi108\\templates\\components\\search\\display_data.html.twig");
    }
}
