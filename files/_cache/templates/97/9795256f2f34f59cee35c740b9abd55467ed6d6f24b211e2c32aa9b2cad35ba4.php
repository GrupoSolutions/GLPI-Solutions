...
class __TwigTemplate_dd82722557f310471b3d35ea773ac236f05dbc989ed7ecca5d18a3c646ff3516 extends Template
{
    private $source;
    private $macros = [];
...
<body class=\"{{ user_pref('fold_menu') and is_vertical ? 'navbar-collapsed' : '' }} {{ is_vertical ? 'vertical-layout' : 'horizontal-layout' }} {{ is_debug_active ? 'debug-active' : '' }}\">
   ...
   <div class=\"page\">
      ...
      <div class=\"page-wrapper mb-0\">
         <div class=\"page-body container-fluid\">
            <main role=\"main\" id=\"page\" class=\"legacy\">
", "layout/parts/page_header.html.twig", "C:\\wamp64\\www\\glpi106\\templates\\layout\\parts\\page_header.html.twig");
    }
}
