...
class __TwigTemplate_3f08f37a1197d38dc294831a1c2e9cd4 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"POST\" action=\"{{ form_path }}\" enctype=\"{{ enctype }}\"
   ...
   {% if params['_hidden_fields'] is defined and params['_hidden_fields']|length > 0 %}
      ...
      {% endfor %}
   {% endif %}
", "components/itilobject/mainform_open.html.twig", "C:\\wamp64\\www\\glpi108\\templates\\components\\itilobject\\mainform_open.html.twig");
    }
}
