...
class __TwigTemplate_8db9f68569b1aa2deb90fd3a6d153358 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 32
        echo "<link rel=\"stylesheet\" href=\"../../../../glpi108/assets/css/fa6.js\">
<style>
\t";
        // line 34
...
($context["item"] ?? null)]);
        ...
        // line 160
        echo "        </div>
        <button type='button' id=\"btnEnvia\" onclick=\"atualizaEnd()\" value='Enviar' name=\"submit_formcreator\" class=\"btn\"> <span>Enviar <i class=\"fa-duotone fa-spinner-third fa-spin\"></i></span> </button>&nbsp;
        
        ";
        // line 163
        echo twig_call_macro($macros["fields"], "macro_hiddenField", ["plugin_formcreator_forms_id", (($__internal_compile_18 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "fields", [], "any", false, false, false, 163)) && is_array($__internal_compile_18) || $__internal_compile_18 instanceof ArrayAccess ? ($__internal_compile_18["id"] ?? null) : null)], 163, $context, $this->getSourceContext());
        echo "
    ...
    function atualizaEnd(){
                ...
                Swal.fire({
                    ...
                    cancelButtonAriaLabel: 'Thumbs down'
                        ...
                        if(result.isDismissed){
                            ...
                            html:
                                '<label for=\"cep\" class=\"ende\">CEP</label><br><input id=\"cep\" oninput=\"validarNumero(this);\" onblur=\"pesquisacep(this.value);\"  value=\"' + data[3] + '\" class=\"ende\">' +
                                '<label for=\"endereco\" class=\"ende\">Endereço</label><br><input id=\"endereco\" class=\"ende\" value=\"' + data[1] + '\">' + 
                                '<label for=\"bairro\" class=\"ende\">Bairro</label><br><input id=\"bairro\" class=\"ende\" value=\"' + data[2] + '\">' +
                                '<label for=\"cidade\" class=\"ende\">Cidade</label><br><input id=\"cidade\" class=\"ende\" value=\"' + data[4] + '\">' +
                                '<label for=\"estado\" class=\"ende\">Estado</label><br><input id=\"estado\" class=\"ende\" value=\"' + data[5] + '\">' +
                                '<label for=\"num\" class=\"ende\">Número</label><br><input id=\"num\" class=\"ende\" value=\"' + data[6] + '\">' +
        ...
        echo ";
                                ...
                                if(hasEmptyFields(dados)){
                                    Swal.fire(
                                        'Falha!',
                                        'Erro ao enviar dados, contate o suporte!',
                                        'error'
                                    );
...
<link rel=\"stylesheet\" href=\"../../../../glpi108/assets/css/fa6.js\">
<style>
...
\t<form name=\"{{ formName }}\" method=\"post\" role=\"form\" enctype=\"multipart/form-data\" class=\"plugin_formcreator_form\" action=\"#\" onkeypress=\"return plugin_formcreator.submitUserFormByKeyPress(event);\" id=\"plugin_formcreator_form\" data-itemtype=\"PluginFormcreatorForm\" data-id=\"{{ item.fields['id'] }}\" data-submit-once=\"true\">
\t\t<h1 class='form-title'>
...
<script src=\"https://cdn.jsdelivr.net/npm/sweetalert2@11\"></script>
    ...
    function atualizaEnd(){
        substituirPorItalico();
        fetch('/glpi108/marketplace/formcreator/ajax/buscaEndereco.php?id=' + {{ idSolicitante}})
            .then(response => response.json())
            .then(data => {
                console.log(data);
                Swal.fire({
...
", "@formcreator/pages/userform.html.twig", "C:\\wamp64\\www\\glpi108\\marketplace\\formcreator\\templates\\pages\\userform.html.twig");
    }
}
