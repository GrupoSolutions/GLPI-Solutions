...
class __TwigTemplate_36ac8df197b1fa8cf6819f748006951e extends Template
{
    private $source;
    private $macros = [];
...
";
      ...
      <img src=\"https://cdn.onlinewebfonts.com/svg/img_423551.png\" style=\"filter: invert(100%)\" width=\"18\"/>
         <strong class=\"me-auto\" style=\"margin-left:10px;\">HelpDesk</strong>
         <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"toast\" aria-label=\"Close\"></button>
      </div>

      <div class=\"toast-body\">
\t<a style=\"color:white;\" href=\"ticket.form.php?id=";
            // line 155
...
{% for i in novo_chamado %}
   <div class=\"toast animate__animated animate__tada animate__delay-2s animate__slow\" style=\"padding: 5px 15px;\" role=\"alert\" aria-live=\"assertive\" aria-atomic=\"true\">
      ...
      <div class=\"toast-body\">
\t<a style=\"color:white;\" href=\"ticket.form.php?id={{ i }}\"/>
         #{{ i }} - Novo Chamado 
\t</a>
      </div>
...
{% for j in sem_resposta %}
   <div class=\"toast animate__animated animate__tada animate__delay-2s animate__slow\" style=\"padding: 5px 15px;\" role=\"alert\" aria-live=\"assertive\" aria-atomic=\"true\">
      ...
      <div class=\"toast-body\">
\t<a style=\"color:white;\" href=\"ticket.form.php?id={{ j }}\"/>
