...
class __TwigTemplate_e86b6715fe2f4a82afe15523ec51815b37c1ccc4b19e05244fe4f96458df0b57 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        // line 40
        if (((0 === twig_compare(($context["user_thumbnail"] ?? null), null)) &&  !$this->extensions['Glpi\Application\View\Extension\ConfigExtension']->getEntityConfig("display_users_initials", $this->extensions['Glpi\Application\View\Extension\SessionExtension']->session("glpiactive_entity")))) {
            // line 41
            echo "    ";
...
";
    ...
    {
        return new Source("", "components/user/picture.html.twig", "C:\\wamp64\\www\\glpi104\\templates\\components\\user\\picture.html.twig");
    }
}
