...
class __TwigTemplate_873a35e9edfccca85cdb322b9a4651a6 extends Template
{
    private $source;
    private $macros = [];
...
{% macro dropdownUrgencyType(name, value, label = '', options = {}) %}
   ...
   {{ fields.field(name, field, label, options) }}
{% endmacro %}
", "@formcreator/components/form/fields_macros.html.twig", "/var/www/html/glpi/marketplace/formcreator/templates/components/form/fields_macros.html.twig");
    }
}
