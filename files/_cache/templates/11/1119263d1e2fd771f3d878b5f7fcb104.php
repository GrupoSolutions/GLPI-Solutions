...
class __TwigTemplate_b9007f5fc71ca7f50a26d60e474393f8 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"p-0 user-info-card\">
   <div class=\"row\">
      ...
      <div class=\"col-auto ms-2\">
         <h4 class=\"card-title mb-1\">
            {% if user['id'] %}
               <a href=\"{{ 'User'|itemtype_form_path(user['id']) }}\">{{ user['firstname'] }}</a>
            {% else %}
               {{ user['firstname'] }}
            {% endif %}
         </h4>
         ...
         <div class=\"text-muted\">
            ...
            {% if user['usercategories_id'] > 0 %}
               <div title=\"{{ _n('Departamento', 'Categories', 1) }}\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\">
                  <i class=\"fas fa-fw fa-user-tag\"></i>
...
", "components/user/info_card.html.twig", "C:\\wamp64\\www\\glpi108\\templates\\components\\user\\info_card.html.twig");
    }
}
