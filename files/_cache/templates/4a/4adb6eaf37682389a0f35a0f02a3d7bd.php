...
class __TwigTemplate_5dcbd5cb05988ed8918c877d70cca147 extends Template
{
    private $source;
    private $macros = [];
...
{% if not enable_anonymization %}
    ...
    {% endif %}
{% endif %}
", "components/user/link_with_tooltip.html.twig", "/var/www/html/glpi/templates/components/user/link_with_tooltip.html.twig");
    }
}
