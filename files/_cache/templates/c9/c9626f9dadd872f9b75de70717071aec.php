...
class __TwigTemplate_d8f211c196c27603b2d63b5e8eaf2337 extends Template
{
    private $source;
    private $macros = [];
...
($context["filters"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["date"] ?? null) : null), "", ["no_label" => true, "full_width" => true, "mb" => ""]], 89, $context, $this->getSourceContext());
      ...
      ";
         ...
         ";
            ...
            ";
                    // line 138
                    if (((($__internal_compile_5 = $context["entry"]) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5["field"] ?? null) : null) == "Insumo")) {
                        // line 139
                        echo "               ";
                        $context["insumo"] = "true";
                        // line 140
...
";
    ...
    {
        return new Source("", "components/logs.html.twig", "C:\\wamp64\\www\\glpi108\\templates\\components\\logs.html.twig");
    }
}
