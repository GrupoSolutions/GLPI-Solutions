...
class __TwigTemplate_a147307693121735725f7aee77a18fb92be0b478b623a6c5ccba0c2c7f05e3c1 extends Template
{
    private $source;
    private $macros = [];
...
($context["condition"] ?? null), "fields", [], "any", false, false, false, 40)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["show_logic"] ?? null) : null)), "width" => "100%", "display_emptychoice" => false, "field_class" => "col-12 col-sm-1", "no_label" => true];
        ...
        // line 47
        echo "                    ";
        $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Dropdown::showFromArray", [0 => "_conditions[show_logic][]", 1 => ($context["elements"] ?? null), 2 => ($context["options"] ?? null)]);
        // line 48
        echo "                ";
        ...
        // line 58
        echo "                ";
        $context["excludeQuestions"] = $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("PluginFormcreatorCondition::getQuestionsExclusion", [0 => ($context["parent"] ?? null)]);
        // line 59
        echo "                ";
        $context["form"] = $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("PluginFormcreatorForm::getByItem", [0 => ($context["parent"] ?? null)]);
        // line 60
        echo "                ";
        ob_start(function () { return ''; });
        // line 61
        echo "                    ";
        $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("PluginFormcreatorQuestion::dropdownForForm", [0 => ($context["form"] ?? null), 1 => ($context["excludeQuestions"] ?? null), 2 => "_conditions[plugin_formcreator_questions_id][]", 3 => (($__internal_compile_1 = twig_get_attribute($this->env, $this->source, ($context["condition"] ?? null), "fields", [], "any", false, false, false, 61)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["plugin_formcreator_questions_id"] ?? null) : null)]);
        // line 62
        echo "                ";
        $context["field"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 63
...
($context["condition"] ?? null), "fields", [], "any", false, false, false, 68)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["show_condition"] ?? null) : null)), "width" => "100%", "display_emptychoice" => false, "field_class" => "col-12 col-sm-1", "no_label" => true];
        ...
        // line 75
        echo "                    ";
        $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Dropdown::showFromArray", [0 => "_conditions[show_condition][]", 1 => ($context["elements"] ?? null), 2 => ($context["options"] ?? null)]);
        // line 76
        echo "                ";
        $context["field"] = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 77
    ...
    {
        return new Source("", "@formcreator/components/form/condition.html.twig", "C:\\xampp\\htdocs\\glpi\\marketplace\\formcreator\\templates\\components\\form\\condition.html.twig");
    }
}
