       ...
       // Affiche un formulaire User
        ...
        if (
           ...
           //display login field for new records, or if this is not external auth
            echo "<td><input name='name' id='name' value=\"" . $this->fields["name"] . "\" class='form-control usuInput'></td>";
        } else {
       ...
       //do some rights verification
        if (
            ...
            echo "<td><input id='password' type='password' name='password' value='' size='20'
                    autocomplete='new-password' onkeyup=\"return passwordCheck();\" class='form-control usuInput'></td>";

            echo "<tr class='tab_bg_1'>";
            echo "<td><label for='password2'>" . __('Password confirmation') . "</label></td>";
            echo "<td><input type='password' id='password2' name='password2' value='' size='20' autocomplete='new-password' class='form-control usuInput'>";
            echo "</td></tr>";
        ...
        if (!GLPI_DEMO_MODE) {
            ...
            Dropdown::showYesNo('is_active', $this->fields['is_active'], -1, ['rand' => $activerand, 'class' => "usuInput"]);
            echo "</td>";
        } else {
            echo "<td colspan='2'></td>";
        }
        echo "<tr><td>" . _n('Email', 'Email', Session::getPluralNumber());
