...
class __TwigTemplate_ca55a7a1e24fc2e3e7d3f7def5042463 extends Template
{
    private $source;
    private $macros = [];
...
{% if not is_ajax %}
   ...
   {% endif %}
{% endif %}
", "components/search/display_data.html.twig", "C:\\wamp64\\www\\glpi05\\templates\\components\\search\\display_data.html.twig");
    }
}
