...
class __TwigTemplate_389de3a9b0a837bc9a9f477455c266a2 extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"POST\" action=\"{{ form_path }}\" enctype=\"{{ enctype }}\"
   ...
   {% if params['_hidden_fields'] is defined and params['_hidden_fields']|length > 0 %}
      ...
      {% endfor %}
   {% endif %}
", "components/itilobject/mainform_open.html.twig", "C:\\wamp64\\www\\glpi05\\templates\\components\\itilobject\\mainform_open.html.twig");
    }
}
