...
class __TwigTemplate_ac0c8602c7b251f7bb25cf8898328363 extends Template
{
    private $source;
    private $macros = [];
...
($context["item"] ?? null), "input", [], "any", false, true, false, 39), "status", [], "array", true, true, false, 39)) ? (_twig_default_filter((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "input", [], "any", false, true, false, 39)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["status"] ?? null) : null), "SIM")) : ("SIM")), "value_calculation" => (($__internal_compile_1 = twig_get_attribute($this->env, $this->source,             // line 40
($context["item"] ?? null), "fields", [], "any", false, false, false, 40)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["status"] ?? null) : null), "showtype" => "allowed", "width" => "100%", "display" => false],             // line 44
...
{% if canupdate %}
   {% set status_field %}
      {{ item.dropdownStatus({
         'value': item.input['status']|default(\"SIM\"),
...
", "components/itilobject/fields/status.html.twig", "C:\\wamp64\\www\\glpi05\\templates\\components\\itilobject\\fields\\status.html.twig");
    }
}
