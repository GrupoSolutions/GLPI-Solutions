...
class __TwigTemplate_b9eed7536c77a62449fe45710a457e5f extends Template
{
    private $source;
    private $macros = [];
...
{% macro dropdownUrgencyType(name, value, label = '', options = {}) %}
   ...
   {{ fields.field(name, field, label, options) }}
{% endmacro %}
", "@formcreator/components/form/fields_macros.html.twig", "C:\\wamp64\\www\\glpi\\marketplace\\formcreator\\templates\\components\\form\\fields_macros.html.twig");
    }
}
