...
class __TwigTemplate_05c195b87b1147441fb0794215078aae3d2a5d14e9b517449d669ce8e044c0cc extends Template
{
    private $source;
    private $macros = [];
...
($context["withtemplate"] ?? null), ["required" => true]], 54, $context, $this->getSourceContext());
        ...
        echo "
                    ...
                    ";
        // line 64
        echo twig_call_macro($macros["fields"], "macro_smallTitle", [__("Condition to show the question", "formcreator")], 64, $context, $this->getSourceContext());
        echo "
   ...
   ";
        // line 88
        if ((0 === twig_compare((($__internal_compile_6 = ($context["params"] ?? null)) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["formfooter"] ?? null) : null), null))) {
            // line 89
   ...
   ";
    ...
    {
        return new Source("", "@formcreator/pages/section.html.twig", "C:\\xampp\\htdocs\\glpi\\marketplace\\formcreator\\templates\\pages\\section.html.twig");
    }
}
