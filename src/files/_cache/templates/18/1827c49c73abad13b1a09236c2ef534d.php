...
class __TwigTemplate_cf892f59d9dfb841fc30081d0a2f37d7 extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    {{ toasts_html }}
{% endif %}
", "components/messages_after_redirect_toasts.html.twig", "C:\\wamp64\\www\\glpi05\\templates\\components\\messages_after_redirect_toasts.html.twig");
    }
}
