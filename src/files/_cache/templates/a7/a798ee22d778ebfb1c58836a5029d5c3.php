...
class __TwigTemplate_84aaf5d09d62bb9dc6058bf7cfc2e963 extends Template
{
    private $source;
    private $macros = [];
...
($context["type"] ?? null) == "dropdown")) {
                // line 91
                echo "        ";
                $context["dropdown_options"] = ["entity" => twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getEntityID", [], "method", false, false, false, 91)];
                // line 92
                echo "        ";
                ...
                // line 101
                echo "        ";
                echo twig_call_macro($macros["macros"], "macro_dropdownField", [($context["dropdown_itemtype"] ?? null), ($context["name_fk"] ?? null), ($context["value"] ?? null), ($context["label"] ?? null), twig_array_merge(($context["field_options"] ?? null), ($context["dropdown_options"] ?? null))], 101, $context, $this->getSourceContext());
                echo "

    ";
            } elseif (preg_match("/^dropdown-.+/i",             // line 103
($context["type"] ?? null))) {
                // line 104
                echo "        ";
...
($context["type"] ?? null) == "glpi_item")) {
            ...
            <div class='form-field row col-12 col-sm-6  mb-2'>
                ";
                    // line 123
                    echo twig_call_macro($macros["macros"], "macro_dropdownArrayField", [(($context["itemtype_prefix"] ?? null) . ($context["name"] ?? null)), twig_get_attribute($this->env, $this->source, ($context["value"] ?? null), "itemtype", [], "any", false, false, false, 123), (($__internal_compile_15 = $context["field"]) && is_array($__internal_compile_15) || $__internal_compile_15 instanceof ArrayAccess ? ($__internal_compile_15["allowed_values"] ?? null) : null), ($context["label"] ?? null), twig_array_merge(($context["field_options"] ?? null), ["rand" =>                     // line 124
($context["rand"] ?? null), "display_emptychoice" => true])], 123, $context, $this->getSourceContext());
                    // line 126
                    echo "

                ";
                    // line 128
                    $this->extensions['Glpi\Application\View\Extension\PhpExtension']->call("Ajax::updateItemOnSelectEvent", [0 => ((("dropdown_" .                     // line 130
($context["itemtype_prefix"] ?? null)) . ($context["name"] ?? null)) . ($context["rand"] ?? null)), 1 => ("results_items_id" .                     // line 131
($context["rand"] ?? null)), 2 => ($this->extensions['Glpi\Application\View\Extension\ConfigExtension']->config("root_doc") . "/ajax/dropdownAllItems.php"), 3 => ["idtable" => "__VALUE__", "name" => (                    // line 135
($context["items_id_prefix"] ?? null) . ($context["name"] ?? null)), "entity_restrict" => twig_get_attribute($this->env, $this->source,                     // line 136
($context["item"] ?? null), "getEntityID", [], "method", false, false, false, 136), "dom_name" => (                    // line 137
($context["items_id_prefix"] ?? null) . ($context["name"] ?? null)), "display_emptychoice" => false, "action" => "get_items_from_itemtype", "dom_rand" =>                     // line 140
($context["rand"] ?? null)]]);
                    // line 143
                    echo "
                <span id='results_items_id";
                    ...
                    ";
                    // line 145
                    if ((twig_get_attribute($this->env, $this->source, ($context["value"] ?? null), "itemtype", [], "any", false, false, false, 145) != "")) {
                        // line 146
                        echo "                        ";
                        echo twig_call_macro($macros["macros"], "macro_dropdownField", [twig_get_attribute($this->env, $this->source, ($context["value"] ?? null), "itemtype", [], "any", false, false, false, 146), (($context["items_id_prefix"] ?? null) . ($context["name"] ?? null)), twig_get_attribute($this->env, $this->source, ($context["value"] ?? null), "items_id", [], "any", false, false, false, 146), ($context["label"] ?? null), twig_array_merge(($context["field_options"] ?? null), ["entity" => (((twig_get_attribute($this->env, $this->source,                         // line 147
($context["value"] ?? null), "itemtype", [], "any", false, false, false, 147) == "User")) ? ( -1) : (twig_get_attribute($this->env, $this->source, ($context["item"] ?? null), "getEntityID", [], "method", false, false, false, 147))), "rand" =>                         // line 148
($context["rand"] ?? null), "right" => "all", "display_emptychoice" => false, "no_label" => true])], 146, $context, $this->getSourceContext());
                        // line 152
                        echo "
                    ";
                    }
...
";
    ...
    {
        return array (  328 => 161,  326 => 160,  323 => 159,  315 => 156,  311 => 154,  307 => 152,  305 => 148,  304 => 147,  302 => 146,  300 => 145,  296 => 144,  293 => 143,  291 => 140,  290 => 137,  289 => 136,  288 => 135,  287 => 131,  286 => 130,  285 => 128,  281 => 126,  279 => 124,  278 => 123,  274 => 121,  271 => 120,  268 => 119,  265 => 118,  263 => 117,  260 => 116,  254 => 114,  251 => 113,  248 => 112,  245 => 111,  242 => 110,  239 => 109,  236 => 108,  233 => 107,  230 => 106,  227 => 105,  224 => 104,  222 => 103,  216 => 101,  213 => 100,  210 => 99,  207 => 98,  204 => 97,  201 => 96,  198 => 95,  195 => 94,  192 => 93,  189 => 92,  186 => 91,  184 => 90,  178 => 88,  176 => 87,  170 => 85,  168 => 84,  162 => 82,  160 => 81,  154 => 79,  152 => 78,  149 => 77,  147 => 76,  145 => 74,  142 => 73,  136 => 70,  130 => 68,  127 => 67,  124 => 66,  122 => 65,  116 => 63,  114 => 62,  108 => 60,  106 => 59,  100 => 57,  98 => 56,  95 => 55,  93 => 53,  92 => 52,  91 => 51,  90 => 50,  87 => 49,  84 => 48,  81 => 47,  78 => 46,  75 => 45,  72 => 44,  70 => 43,  67 => 42,  63 => 41,  60 => 40,  52 => 34,  50 => 33,  47 => 32,  45 => 31,  42 => 30,  40 => 29,  37 => 28,);
    }
