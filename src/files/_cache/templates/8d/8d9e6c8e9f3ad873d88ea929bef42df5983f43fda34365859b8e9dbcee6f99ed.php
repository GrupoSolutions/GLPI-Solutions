...
class __TwigTemplate_e3ce2f5bdfe3496110f736607e5fc6f5ef8d8e0654944ee37a41ab48360aaafd extends Template
{
    private $source;
    private $macros = [];
...
($context["item"] ?? null), "entities_id" => (($__internal_compile_9 =             // line 198
($context["params"] ?? null)) && is_array($__internal_compile_9) || $__internal_compile_9 instanceof ArrayAccess ? ($__internal_compile_9["entities_id"] ?? null) : null), "itiltemplate" =>             // line 199
...
($context["itiltemplate"] ?? null), "isMandatoryField", [0 => "_users_id_observer"], "method", false, false, false, 213) || twig_get_attribute($this->env, $this->source, ($context["itiltemplate"] ?? null), "isMandatoryField", [0 => "_groups_id_observer"], "method", false, false, false, 213))])], 208, $context, $this->getSourceContext());
        ...
        echo "
               ";
        // line 218
        echo twig_call_macro($macros["fields"], "macro_dropdownField", ["Location", "locations_id", (($__internal_compile_10 =         // line 221
($context["params"] ?? null)) && is_array($__internal_compile_10) || $__internal_compile_10 instanceof ArrayAccess ? ($__internal_compile_10["locations_id"] ?? null) : null), $this->extensions['Glpi\Application\View\Extension\ItemtypeExtension']->getItemtypeName("Location"), twig_array_merge(        // line 223
($context["right_field_options"] ?? null), ["hide_if_no_elements" => true])], 218, $context, $this->getSourceContext());
        ...
        echo "
               ...
               ";
        // line 228
        echo twig_call_macro($macros["fields"], "macro_textField", ["name", (($__internal_compile_11 =         // line 230
($context["params"] ?? null)) && is_array($__internal_compile_11) || $__internal_compile_11 instanceof ArrayAccess ? ($__internal_compile_11["name"] ?? null) : null), __("Title"),         // line 232
($context["right_field_options"] ?? null)], 228, $context, $this->getSourceContext());
        ...
        echo "
               ...
               ";
        // line 235
        echo twig_call_macro($macros["fields"], "macro_textareaField", ["content", (($__internal_compile_12 =         // line 237
($context["params"] ?? null)) && is_array($__internal_compile_12) || $__internal_compile_12 instanceof ArrayAccess ? ($__internal_compile_12["content"] ?? null) : null), __("Description"), twig_array_merge(        // line 239
($context["right_field_options"] ?? null), ["enable_richtext" => true, "enable_fileupload" => true])], 235, $context, $this->getSourceContext());
        // line 243
        echo "
            </div>
        </div>
