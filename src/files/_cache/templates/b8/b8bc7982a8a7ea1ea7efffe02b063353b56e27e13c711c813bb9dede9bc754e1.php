...
class __TwigTemplate_3e543fb444f5d12ddfdccbc124b68c6a963f35901eec629d3bd7b2b89dbbb25a extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"message-area\">
   ";
        // line 35
        if ((twig_get_attribute($this->env, $this->source, ($context["messages"] ?? null), "errors", [], "any", true, true, false, 35) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["messages"] ?? null), "errors", [], "any", false, false, false, 35)), 0)))) {
            // line 36
   ...
   ";
        ...
        // line 45
        echo "   ";
        if ((twig_get_attribute($this->env, $this->source, ($context["messages"] ?? null), "warnings", [], "any", true, true, false, 45) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["messages"] ?? null), "warnings", [], "any", false, false, false, 45)), 0)))) {
            // line 46
   ...
   ";
        ...
        // line 55
        echo "   ";
        if ((twig_get_attribute($this->env, $this->source, ($context["messages"] ?? null), "infos", [], "any", true, true, false, 55) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["messages"] ?? null), "infos", [], "any", false, false, false, 55)), 0)))) {
            // line 56
...
";
    ...
    {
        return new Source("", "central/messages.html.twig", "C:\\wamp64\\www\\glpi104\\templates\\central\\messages.html.twig");
    }
}
