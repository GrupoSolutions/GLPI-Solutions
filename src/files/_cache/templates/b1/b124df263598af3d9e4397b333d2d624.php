...
class __TwigTemplate_a2b21221e6f577e60324d417ba3377b2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_questionParameters($context, array $blocks = [])
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["parameter"]) {
            // line 79
            echo "        ";
            echo twig_get_attribute($this->env, $this->source, $context["parameter"], "getParameterForm", [0 => ($context["item"] ?? null)], "method", false, false, false, 79);
            echo "
    ";
        }
    ...
    {
        return new Source("", "@formcreator/field/selectfield.html.twig", "C:\\wamp64\\www\\glpi\\marketplace\\formcreator\\templates\\field\\selectfield.html.twig");
    }
}
