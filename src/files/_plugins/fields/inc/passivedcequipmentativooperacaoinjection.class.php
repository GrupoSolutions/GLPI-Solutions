...
class PluginFieldsPassivedcequipmentativooperacaoInjection extends PluginFieldsPassivedcequipmentativooperacao implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return PassiveDCEquipment::getTypeName() . " - ativoOperacao";
   }
   ...
   **/
   function connectedTo() {
      return array('PassiveDCEquipment');
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('PassiveDCEquipment', 5);
