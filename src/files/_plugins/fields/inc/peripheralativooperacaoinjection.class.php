...
class PluginFieldsPeripheralativooperacaoInjection extends PluginFieldsPeripheralativooperacao implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Peripheral::getTypeName() . " - ativoOperacao";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Peripheral', 5);
