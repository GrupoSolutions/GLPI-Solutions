...
class PluginFieldsLocationtesteInjection extends PluginFieldsLocationteste implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Location::getTypeName() . " - Teste";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Location', 4);
