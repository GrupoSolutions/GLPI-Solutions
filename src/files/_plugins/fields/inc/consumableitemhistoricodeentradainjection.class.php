...
class PluginFieldsConsumableitemhistoricodeentradaInjection extends PluginFieldsConsumableitemhistoricodeentrada implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return ConsumableItem::getTypeName() . " - Historico de Entrada";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('ConsumableItem', 3);
