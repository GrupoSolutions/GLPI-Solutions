...
class PluginFieldsMonitorativooperacaoInjection extends PluginFieldsMonitorativooperacao implements PluginDatainjectionInjectionInterface
{
   ...
   **/
   ...
   static function getTypeName($nb = 0) {
      return Monitor::getTypeName() . " - ativoOperacao";
   }
   ...
   **/
   function getOptions($primary_type='') {
      $searchoptions = PluginFieldsContainer::getAddSearchOptions('Monitor', 5);
