...
if (isset($_REQUEST['generate'])) {
   ...
   if ($PluginUseditemsexportExport::generatePDF($_POST['users_id'])) {
      Session::addMessageAfterRedirect(__('Termo gerado com sucesso!', 'useditemsexport'), true);
      Html::back();
   }
}
if (isset($_REQUEST['generateDev'])) {

   if ($PluginUseditemsexportExport::generateTermoDev($_POST['users_id'])) {
      Session::addMessageAfterRedirect(__('Termo gerado com sucesso!', 'useditemsexport'), true);
      Html::back();
   }
}
