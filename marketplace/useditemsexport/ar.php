...
<div class="container">
    <div class="row mt-5">
        ...
        <div class="destinatario pb-2 ">
            ...
            <p class="ml-2"><?php echo $nome; ?><br><?php echo $rua;echo " N°$numero";  ?><br><?php echo $bairro; ?><br><?php echo $cep; ?>     <?php echo $cidade; ?>-<?php echo $estado; ?></p>
            <div class="pl-1">
            <?php
                        ...
                        <table border="0" width="370px" height="176px">
                            ...
                            <td valign="top" class="style24">
                                ...
                                <br> <?php echo $rua;echo " N°$numero";?> <br>
                                    <?php echo $bairro ?>						
                                <br>
                                <?php echo $cep;?> <?php echo $cidade;?>-<?php echo $estado;?>
                            </span> </td>
                            </tr>
                            <p></p><p></p>
                            <tr>
